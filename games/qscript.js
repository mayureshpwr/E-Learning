const quizData = [
    ...
    },
    {
      ...
      options: ['Exponentiation', 'Modulus','Floor division','None of the mentioned above'],
      answer: 'Exponentiation',
    },
    {
      question: 'list, tuple, and range are the ___ of Data Types.',
      options: ['Sequence Types', 'Binary Types', 'Boolean Types', 'None of the mentioned above'],
      answer: 'Sequence Types',
    },
    {
      question: 'Python Dictionary is used to store the data in a ___ format.',
      options: ['Key value pair', 'Group value pair', 'Select value pair', 'None of the mentioned above'],
